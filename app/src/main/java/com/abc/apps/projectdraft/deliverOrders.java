...
public class  deliverOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.order_deliver);
        name=findViewById(R.id.usern);
        ordertxt=findViewById(R.id.details);
    ...
    public void done_onClick(View view) {
        ...
        RequestQueue queue = Volley.newRequestQueue(deliverOrders.this);
        StringRequest request = new StringRequest(Request.Method.POST, url, new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Toast.makeText(deliverOrders.this,
        ...
        queue.add(request);
        Intent intent= new Intent(deliverOrders.this,deliver_main.class);
